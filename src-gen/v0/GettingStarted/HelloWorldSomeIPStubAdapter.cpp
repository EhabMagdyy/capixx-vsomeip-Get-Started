 ...
 */
#include <v0/GettingStarted/HelloWorldSomeIPStubAdapter.hpp>
...
std::shared_ptr<CommonAPI::SomeIP::StubAdapter> createHelloWorldSomeIPStubAdapter(
    ...
    return std::make_shared< HelloWorldSomeIPStubAdapter<::v0::GettingStarted::HelloWorldStub>>(_address, _connection, _stub);
}
