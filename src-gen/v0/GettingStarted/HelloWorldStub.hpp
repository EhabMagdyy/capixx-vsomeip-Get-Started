...
*/
#ifndef V0_GETTINGSTARTED_Hello_World_STUB_HPP_
#define V0_GETTINGSTARTED_Hello_World_STUB_HPP_
...
#include <v0/GettingStarted/HelloWorld.hpp>
...
class HelloWorldStubAdapter
 ...
 public:
    /**
    * Sends a broadcast event for notifyGreeting. Should not be called directly.
    * Instead, the "fire<broadcastName>Event" methods of the stub should be used.
    */
    virtual void fireNotifyGreetingEvent(const std::string &_greeting) = 0;
...
public:
    ...
    /// Sends a broadcast event for notifyGreeting.
    virtual void fireNotifyGreetingEvent(const std::string &_greeting) {
        auto stubAdapter = CommonAPI::Stub<HelloWorldStubAdapter, HelloWorldStubRemoteEvent>::stubAdapter_.lock();
        if (stubAdapter)
            stubAdapter->fireNotifyGreetingEvent(_greeting);
    }
    ...
    typedef ::v0::GettingStarted::HelloWorld StubInterface;
};
...
#endif // V0_GETTINGSTARTED_Hello_World_STUB_HPP_
