 ...
 */
#ifndef V0_GETTINGSTARTED_HELLO_WORLD_SOMEIP_STUB_ADAPTER_HPP_
#define V0_GETTINGSTARTED_HELLO_WORLD_SOMEIP_STUB_ADAPTER_HPP_

#include <v0/GettingStarted/HelloWorldStub.hpp>
...
template <typename _Stub = ::v0::GettingStarted::HelloWorldStub, typename... _Stubs>
...
public:
    ...
    void fireNotifyGreetingEvent(const std::string &_greeting);

    void deactivateManagedInstances() {}
    
    CommonAPI::SomeIP::GetAttributeStubDispatcher<
        ::v0::GettingStarted::HelloWorldStub,
        CommonAPI::Version
    ...
    {
        HelloWorldSomeIPStubAdapterHelper::addStubDispatcher( { CommonAPI::SomeIP::method_id_t(0x1770) }, &sayHelloStubDispatcher );
...
void HelloWorldSomeIPStubAdapterInternal<_Stub, _Stubs...>::fireNotifyGreetingEvent(const std::string &_greeting) {
    CommonAPI::Deployable< std::string, CommonAPI::SomeIP::StringDeployment> deployed_greeting(_greeting, static_cast< CommonAPI::SomeIP::StringDeployment* >(nullptr));
...
#endif // V0_GETTINGSTARTED_Hello_World_SOMEIP_STUB_ADAPTER_HPP_
