...
*/
#ifndef V0_GETTINGSTARTED_Hello_World_STUB_DEFAULT_HPP_
#define V0_GETTINGSTARTED_Hello_World_STUB_DEFAULT_HPP_
...
public:
    ...
    COMMONAPI_EXPORT virtual void fireNotifyGreetingEvent(const std::string &_greeting) {
        HelloWorldStub::fireNotifyGreetingEvent(_greeting);
    }
...
#endif // V0_GETTINGSTARTED_Hello_World_STUB_DEFAULT
