...
*/
#ifndef V0_GETTINGSTARTED_Hello_World_PROXY_HPP_
#define V0_GETTINGSTARTED_Hello_World_PROXY_HPP_

#include <v0/GettingStarted/HelloWorldProxyBase.hpp>
...
public:
    ...
    typedef ::v0::GettingStarted::HelloWorld InterfaceType;
    ...
    /**
     * Returns the wrapper class that provides access to the broadcast notifyGreeting.
     */
    virtual NotifyGreetingEvent& getNotifyGreetingEvent() {
        return delegate_->getNotifyGreetingEvent();
    }
...
#endif // V0_GETTINGSTARTED_Hello_World_PROXY_HPP_
