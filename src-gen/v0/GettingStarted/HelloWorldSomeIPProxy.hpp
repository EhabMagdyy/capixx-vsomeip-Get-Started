 ...
 */
#ifndef V0_GETTINGSTARTED_HELLO_WORLD_SOMEIP_PROXY_HPP_
#define V0_GETTINGSTARTED_HELLO_WORLD_SOMEIP_PROXY_HPP_
...
private:
    CommonAPI::SomeIP::Event<NotifyGreetingEvent, CommonAPI::Deployable< std::string, CommonAPI::SomeIP::StringDeployment >> notifyGreeting_;
...
#endif // V0_GETTINGSTARTED_Hello_World_SOMEIP_PROXY_HPP_
