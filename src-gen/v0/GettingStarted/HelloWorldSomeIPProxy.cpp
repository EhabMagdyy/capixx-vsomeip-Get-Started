 ...
 */
#include <v0/GettingStarted/HelloWorldSomeIPProxy.hpp>
...
void initializeHelloWorldSomeIPProxy() {
    CommonAPI::SomeIP::AddressTranslator::get()->insert(
        "local:GettingStarted.HelloWorld:v0_1:GettingStarted.Instance",
        0x1234, 0x5678, 0, 1);
    CommonAPI::SomeIP::Factory::get()->registerProxyCreateMethod(
        "GettingStarted.HelloWorld:v0_1",
...
HelloWorldSomeIPProxy::HelloWorldSomeIPProxy(
    ...
    const std::shared_ptr<CommonAPI::SomeIP::ProxyConnection> &_connection)
        : CommonAPI::SomeIP::Proxy(_address, _connection),
          notifyGreeting_(*this, 0x1b5a, CommonAPI::SomeIP::event_id_t(0x9476), CommonAPI::SomeIP::event_type_e::ET_EVENT , CommonAPI::SomeIP::reliability_type_e::RT_UNRELIABLE, false, std::make_tuple(static_cast< CommonAPI::SomeIP::StringDeployment* >(nullptr)))
{
}
...
HelloWorldSomeIPProxy::NotifyGreetingEvent& HelloWorldSomeIPProxy::getNotifyGreetingEvent() {
    return notifyGreeting_;
}
